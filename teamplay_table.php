...
<div class="col-md-12" style="background-color:#f1f1f1f1;">
	<p><h2 align="center"><b>Teamplay Stats</b></h2></p>
	<table align="center" style="color:black;border-color: black;" border="4px" cellpadding="10px" width="95%" >
		<tr>
			...
			<th align="center"><b>OUTFIELD POSITION</b></th>
			<th align="center"><b>PASSES</b></th>
			<th align="center"><b>PASSES COMPLETED</b></th>
			<th align="center"><b>PASSING ACCURACY</b></th>
			<th align="center"><b>ASSISTS</b></th>
			<th align="center"><b>CROSSES</b></th>
			<th align="center"><b>DRIBBLES</b></th>
			<th align="center"><b>DUELS WON</b></th>
		</tr>
		<?PHP
	...
	if ($result = $con->query($sql))
 	{
		...
		<tr>
			...
			<td><?php echo $row["Outfield_pos"]; ?></td>
			<td><?php echo $row["Passes"]; ?></td>
			<td><?php echo $row["Passes_completed"]; ?></td>
			<td><?php echo $row["Passing_accuracy"]; ?></td>
			<td><?php echo $row["Assists"]; ?></td>
			<td><?php echo $row["Crosses"]; ?></td>
			<td><?php echo $row["Dribbles"]; ?></td>
			<td><?php echo $row["Duels_won"]; ?></td>
		</tr>
		<?php
		}
 		$result->close();
