...
<div class="col-md-12" style="background-color:#f1f1f1f1;">
	<p><h2 align="center"><b>Goalkeeping Stats</b></h2></p>
	<table align="center" style="color:black;border-color: black;" border="4px" cellpadding="10px" width="95%" >
		<tr>
			...
			<th align="center"><b>APPEARANCES</b></th>
			<th align="center"><b>CLEAN SHEETS</b></th>
			<th align="center"><b>SAVES</b></th>
			<th align="center"><b>PENALTIES SAVED</b></th>
			<th align="center"><b>CONCEDED GOALS</b></th>
			<th align="center"><b>FOULS</b></th>
			<th align="center"><b>YELLOW CARDS</b></th>
			<th align="center"><b>RED CARDS</b></th>
		</tr>
		<?PHP
	...
	if ($result = $con->query($sql))
 	{
		...
		<tr>
			...
			<td><?php echo $row["Penalties_saved"]; ?></td>
			<td><?php echo $row["conceded_goals"]; ?></td>
