...
<?php
// Storing Session
$sql = "SELECT P.Player_Name,P.Player_id,G.Clean_Sheets,P.Club_Name,P.Position FROM player P,goalkeeper G where P.Player_id=G.Player_id ORDER BY Clean_Sheets desc;";
...
<div class="col-md-12" style="background-color:#f1f1f1f1;">
	<p><h2 align="center"><b>Players with most Clean Sheets</b></h2></p>
