...
//$sql2 = "INSERT INTO outfield_player (`Player_id`,`Appearances`,`Outfield_pos`,`fouls`,`yellow_cards`,`red_cards`) VALUES ('$PlayerID', $Apps, '$Outfield', $Fouls, $Yellow, $Red)";
...
if(mysqli_query($con, $sql))
    {
        header("Location: new_player_form_part1b.html");
        exit();
    }
    else
    {
