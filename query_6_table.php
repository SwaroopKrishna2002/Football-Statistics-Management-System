...
<?php
// Storing Session
$sql = "SELECT P.Player_Name,P.Player_id,P.Club_Name,A.Outfield_pos,A.Goals,A.xG FROM player P,attacking_stats A WHERE P.Player_id=A.Player_id ORDER BY Goals DESC;";
...
<div class="col-md-12" style="background-color:#f1f1f1f1;">
	<p><h2 align="center"><b>Top Goal Scorers</b></h2></p>
