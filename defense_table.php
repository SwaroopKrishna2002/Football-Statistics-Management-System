...
<?php
// Storing Session
$sql = "SELECT * FROM defensive_stats;";
...
<div class="col-md-12" style="background-color:#f1f1f1f1;">
	<p><h2 align="center"><b>Defensive Stats</b></h2></p>
	<table align="center" style="color:black;border-color: black;" border="4px" cellpadding="10px" width="95%" >
		<tr>
			...
			<th align="center"><b>TACKLES</b></th>
			<th align="center"><b>BLOCKS</b></th>
			<th align="center"><b>AERIAL DUELS</b></th>
			<th align="center"><b>INTERCEPTIONS</b></th>
			<th align="center"><b>OWN GOALS</b></th>
		</tr>
		<?PHP
	...
	if ($result = $con->query($sql))
 	{
		...
		<tr>
			...
			<td><?php echo $row["Tackles"]; ?></td>
			<td><?php echo $row["Blocks"]; ?></td>
			<td><?php echo $row["Aerial_duels"]; ?></td>
