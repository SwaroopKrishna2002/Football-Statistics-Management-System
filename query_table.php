...
<?php
// Storing Session
$sql = "SELECT C.Club_Name,C.Ranking,L.League_id FROM club C,league L WHERE C.League_id=L.League_id ORDER BY Ranking;";
...
<div class="col-md-12" style="background-color:#f1f1f1f1;">
	<p><h2 align="center"><b>Clubs by Ranking</b></h2></p>
	<table align="center" style="color:black;border-color: black;" border="4px" cellpadding="10px" width="80%" >
		<tr>
			...
			<th align="center"><b>POWER RANKING BY FIFA</b></th>
		</tr>
		<?PHP
