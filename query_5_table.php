...
<?php
// Storing Session
$sql = "SELECT L.LName,L.League_id,C.Club_Name,M.Mgr_Name,M.League_pos,M.Mgr_id FROM club C,manager M,league L WHERE C.Club_Name=M.Club_Name and L.League_id=C.League_id ORDER BY League_pos;";
...
<div class="col-md-12" style="background-color:#f1f1f1f1;">
	<p><h2 align="center"><b>Managers whose Teams have highest League Table finish</b></h2></p>
	<table align="center" style="color:black;border-color: black;" border="4px" cellpadding="10px" width="80%" >
		<tr>
			...
			<th align="center"><b>LEAGUE POSITION</b></th>
		</tr>
		<?PHP
