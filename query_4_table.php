...
<?php
// Storing Session
$sql = "SELECT L.LName,C.Club_Name,M.Mgr_Name,M.Goals_Scored,M.Mgr_id FROM club C,manager M,league L WHERE C.Club_Name=M.Club_Name and L.League_id=C.League_id ORDER BY Goals_Scored DESC;";
...
<div class="col-md-12" style="background-color:#f1f1f1f1;">
	<p><h2 align="center"><b>Managers whose Teams have scored most Goals</b></h2></p>
