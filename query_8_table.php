...
<?php
// Storing Session
$sql = "SELECT P.Player_Name,P.Player_id,T.Assists,P.Club_Name,P.Position FROM player P,teamplay T where P.Player_id=T.Player_id ORDER BY Assists desc;";
...
<div class="col-md-12" style="background-color:#f1f1f1f1;">
	<p><h2 align="center"><b>Players with most Assists</b></h2></p>
