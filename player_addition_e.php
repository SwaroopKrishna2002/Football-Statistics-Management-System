...
$sql = "INSERT INTO defensive_stats (`Outfield_pos`,`Tackles`,`Blocks`,`Aerial_Duels`,`Interceptions`,`Own_Goals`,`Player_id`) VALUES ('$Outfield', $Tackles, $Blocks, $Aerial, $Interceptions, $OwnGoals, '$PlayerID')";
