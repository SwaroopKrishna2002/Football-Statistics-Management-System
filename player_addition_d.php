...
//$sql = "INSERT INTO attacking_stats (`Outfield_pos`,`Goals`,`Shots`,`xG`,`Offsides`,`Touches_opp_box`) VALUES ('$Outfield', $Goals, $Shots, $xG, $Offsides, $Touches)";

$sql = "INSERT INTO teamplay (`Outfield_pos`,`Assists`,`Passes`,`Passes_completed`,`Crosses`,`Passing_accuracy`,`Dribbles`,`Duels_won`,`Player_id`) VALUES ('$Outfield', $Assists, $Passes, $PassesComp, $Crosses, '$Accuracy', $Dribbles, $Duels, '$PlayerID')";

//$sql = "INSERT INTO defensive_stats (`Outfield_pos`,`Tackles`,`Blocks`,`Aerial_Duels`,`Interceptions`,`Own_Goals`) VALUES ('$Outfield', $Tackles, $Blocks, $Aerial, $Interceptions, $OwnGoals)";
