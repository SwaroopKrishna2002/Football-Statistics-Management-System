...
<?php
// Storing Session
$sql = "SELECT P.Player_Name,P.Player_id,P.Club_Name,A.Outfield_pos,A.Goals,A.xG FROM player P,attacking_stats A WHERE P.Player_id=A.Player_id ORDER BY xG DESC;";
...
<div class="col-md-12" style="background-color:#f1f1f1f1;">
	<p><h2 align="center"><b>Players with highest xG(Expected Goals)</b></h2></p>
	<table align="center" style="color:black;border-color: black;" border="4px" cellpadding="10px" width="80%" >
		<tr>
			...
			<th align="center"><b>xG(Expected Goals)</b></th>
		</tr>
		<?PHP
