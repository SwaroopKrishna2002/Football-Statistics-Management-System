...
<?php
// Storing Session
$sql = "SELECT P.Player_Name,P.Player_id,P.Club_Name,P.Position,O.fouls,O.yellow_cards,O.red_cards FROM player P,outfield_player O where P.Player_id=O.Player_id ORDER BY fouls desc;";
...
<div class="col-md-12" style="background-color:#f1f1f1f1;">
	<p><h2 align="center"><b>Players with most Fouls</b></h2></p>
